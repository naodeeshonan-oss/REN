...
function buildPrompt(basePrompt, options = {}, isEdit) {
  ...
  const presets = {
    watercolor:
      "watercolor painting style, delicate washes, paper texture, soft edges, pastel tones",
    disney:
      "Disney-like friendly illustration, soft lighting, expressive but natural facial features (not exaggerated)",
    ghibli:
      "Ghibli-inspired warm tone, hand-painted background, gentle colors, cinematic yet natural",
    anime:
      "anime line-art style with clean outlines and light cel shading, natural proportions",
    simple:
      "simple character style, rounded shapes, limited clean colors, flat shading",
  };
